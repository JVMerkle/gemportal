...
type Cfg struct {
	...
	GemDefaultPort    string `envconfig:"GEM_DEFAULT_PORT" default:"1965"`       // Default Gemini port
	GemRespMemLimit   int64  `envconfig:"GEM_RESP_MEM_LIMIT" default:"31457280"` // Gemini response limit in bytes (30MiB)
	GemRedirectsLimit uint32 `envconfig:"GEM_MAX_REDIRECTS" default:"3"`         // Maximum gemini redirects to follow
}
